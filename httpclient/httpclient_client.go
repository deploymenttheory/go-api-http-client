...
type ClientOptions struct {
	...
	LogEncoding               string // Field for defining the output format of the logs. Use "JSON" for JSON format, "console" for human-readable format
...
func BuildClient(config ClientConfig) (*Client, error) {
	...
	log := logger.BuildLogger(parsedLogLevel, config.ClientOptions.LogEncoding)
	...
	log.Info("New API client initialized",
		...
		zap.String("Log Encoding Format", config.ClientOptions.LogEncoding),
